...
import stuffedAnimal from '../../images/stuffedAnimal.jpg'
import smilePackage from '../../images/smilePackage.jpg'
import plush from '../../images/plush.jpg'

function ShoppingCart ({ basketProps, productQuantity, clearProduct }) {
  ...
  // used whenever update the state
  // used to update the number in the navbar but using Redux instead
  const productImages = product => {
    if (product.tagName === 'stuffedLamb') {
      return stuffedLamb
    } else if (product.tagName === 'stuffedAnimal') {
      return stuffedAnimal
    } else if (product.tagName === 'smilePackage') {
      return smilePackage
    } else if (product.tagName === 'plush') {
      return plush
    }
  }
